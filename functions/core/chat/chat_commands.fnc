...
switch (_command) do
{
	...
	case "!distance": 
	{
		...
		_display closeDisplay 1;
		["SERVER",[player,[["Main","distance", _distance]]],"S_stats_save",false,false]call network_MPExec;
	};
	case "!detail": 
	{
		...
		_display closeDisplay 1;
		["SERVER",[player,[["Main","detail", _detail]]],"S_stats_save",false,false]call network_MPExec;
	};
	case "!spec": 
	{
