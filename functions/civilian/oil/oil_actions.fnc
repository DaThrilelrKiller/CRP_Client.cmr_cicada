...
DTK_Shop_Oil_1 addaction ["","scripts\itemprocess.sqf",["Oil", "OilBarrel", 2], 25, false, true, "LeanRight",format ["player distance _target < 5 && {!([_target,'Process Oil (E)','\crp_data\images\tags\oil']call tag_show)}","",""]];
