...
{
	(_x select 0) addaction ["","noscript.sqf",format["%1 call clothing_menu;",_x], 25, false, true, "LeanRight",format["call %1 && {!([_target,'Clothing Shop (E)','\crp_data\images\tags\Clothing.paa']call tag_show)}",_x select 2]];
